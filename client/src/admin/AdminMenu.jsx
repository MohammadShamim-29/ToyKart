...
export const AdminMenu = () => (
  <Menu>
    ...
    <MenuItemLink to="/admin/cancelled-orders" primaryText="Cancelled" leftIcon={<CancelScheduleSendIcon />} />
    ...
    <MenuItemLink to="/admin/shipping-countries" primaryText="Shipping Countries" leftIcon={<PublicIcon />} />
    <MenuItemLink to="/admin/shipping-districts" primaryText="Shipping Districts" leftIcon={<LocationCityIcon />} />
    <MenuItemLink
      to="/"
